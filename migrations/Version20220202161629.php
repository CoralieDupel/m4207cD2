 ...
 */
final class Version20220202161629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE acces (id INT AUTO_INCREMENT NOT NULL, doc_id INT NOT NULL, util_id INT NOT NULL, auto_id INT NOT NULL, autor VARCHAR(255) NOT NULL, INDEX IDX_D0F43B10895648BC (doc_id), INDEX IDX_D0F43B10CF5D2E80 (util_id), INDEX IDX_D0F43B101D55B925 (auto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
